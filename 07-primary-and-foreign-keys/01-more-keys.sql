...
-- this uses a composite primary key
-- means you can only have 1 instance of the same employee_id and project_id columns
CREATE TABLE projects_employees (
  employee_id INT REFERENCES employees ON DELETE CASCADE,
  project_id INT REFERENCES projects ON DELETE CASCADE,
  -- PRIMARY KEY (employee_id) -- this would have used only the employee_id
